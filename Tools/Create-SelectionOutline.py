...
float selected = step(239.5, Stencil.r) * step(Stencil.r, 242.5);
...
float3 ink = Stencil.r > 241.5 ? float3(1.0,0.18,0.13) : Stencil.r > 240.5 ? float3(0.1,0.75,1.0) : float3(0.12,1.0,0.28);
